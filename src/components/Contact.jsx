      ...
      >
        ...
        <div className="mb-6 flex justify-center">
          <button
            ...
            onClick={() => window.location.href = 'mailto:lundstedtkevin@gmail.com'}
        ...
        <div className="card mx-auto mt-8">
          <a
            ...
            href="https://instagram.com/lundstedtkevin"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram"
          >
            {/* Instagram SVG */}
            <svg style={{ color: "white" }} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
          ...
          >
            {/* GitHub SVG */}
            <svg viewBox="0 0 496 512" height="24" fill="#fff" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* <a
            ...
            href="https://discord.com/kevinlundstedt"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Discord"
          >
             Discord SVG 
            <svg style={{ color: "white" }} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-discord" viewBox="0 0 16 16">
           ...
           <a
            ...
            aria-label="WhatsApp"
          >
            {/* WhatsApp Outline SVG - samma stil som övriga */}
            <svg viewBox="0 0 16 16" className="bi bi-whatsapp" fill="currentColor" width="24" height="24" xmlns="http://www.w3.org/2000/svg" style={{ color: "white" }}>
          ...
          >
            {/* LinkedIn SVG */}
            <svg fill="#fff" viewBox="0 0 448 512" height="24" xmlns="http://www.w3.org/2000/svg">
